...
<article>
  ...
  <ul>
    ...
    <li>fixed: potential critical bug in batch processing caused possible overlap of multiple activations and deactivations</li>
  ...
  <strong>version 0.2.18 - build 400</strong>
  <ul>
    <li>fixed: critical bug if mod name contained special characters</li>
  </ul>
  <strong>version 0.2.17 - build 374</strong>
  <ul>
    <li>added: check online for new version</li>
  </ul>
  <strong>version 0.2.16 - build 361</strong>
  <ul>
